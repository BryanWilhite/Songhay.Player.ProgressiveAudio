namespace Songhay.Player.ProgressiveAudio.Client.Components
...
type ClientProgramComponent() =
    ...
    let update message model =
        ...
        | ProgressiveAudioMessage paMessage ->
            ...
            let cmd = model.paModel |> pcu.getCommandForProgressiveAudio paMessage
            m, cmd
        ...
        | BRollAudioPage _ ->
            concat {
                bulmaSection
                    ...
                    NoAttr
                    (empty())
                PlayerElmishComponent.EComp
                    DispatchConditionally
                    model.paModel
                    (ProgressiveAudioMessage >> dispatch)
                footerElement
    ...
    override this.Program =
        let m = AudioClientModel.initialize this.Services
